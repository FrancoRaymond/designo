...
const About = () => {
  ...
  return (
    <div className={`sm:px-5 md:px-10 lg:px-24 pt-7 mb-48`}>
        <div className={`bg-[var(--accent-color)] flex flex-col-reverse sm:rounded-lg sm:overflow-clip mt-6  ${size > 699 ? 'grid grid-cols-5 pt-0 mb-24 mt-0 rounde-lg overflow-clip' : ''} items-center`}>
        ...
        <div className={`bg-[var(--secondary-accent)] flex flex-col sm:rounded-lg sm:overflow-clip ${size > 699 ? 'grid grid-cols-5 pt-0 mt-0 rounde-lg overflow-clip' : ''} items-center`}>
        ...
        <div className={`bg-[var(--secondary-accent)] mt-10 flex flex-col-reverse sm:rounded-lg sm:overflow-clip ${size > 699 ? 'grid grid-cols-5 mb-28 pt-0 mt-0 rounde-lg overflow-clip' : ''} items-center`}>
            <div className={` py-10 text-center ${size > 699 ? 'col-span-3 text-left h-fit py-0 px-5 md:px-10 lg:px-24' : ''}`}>
